...
opcli tasks create --name "Tên task" --description "Mô tả" --assignee me

# Gán cho người khác
opcli tasks create --name "Tên task" -a "username"

# Interactive mode (không truyền flag)
opcli tasks create
```

Nếu có nhiều project, sẽ hỏi chọn project. Nếu chỉ có 1 project thì tự động chọn.
